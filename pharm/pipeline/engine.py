            ...
            if self.manifest["mode"] == "fixture":
                ...
                output = {
                    ...
                    "provenance": {"data_version": result["data_version"], "source_url": result["source_url"],
                                   "accessed_at": batman_local.accessed_at(self.task),
                                   "threshold": result["threshold"],
                                   "threshold_operator": ">",
                                   "predicted_filter": "predicted score strictly greater than threshold; known evidence is not threshold-filtered",
