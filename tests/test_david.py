...
from pharm_demo.common import read_json, write_json
from pharm_demo.david import DavidBlocked, DavidClient, annotation_ids, chart_rows, conversion_report, mapping_report, run_david, validate_config
...
def test_http_access_denial_is_not_retried_or_bypassed(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("pharm_demo.david.time.sleep", lambda _: None)
